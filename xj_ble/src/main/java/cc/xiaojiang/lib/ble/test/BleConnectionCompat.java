...
public class BleConnectionCompat {
    ...
    public BluetoothGatt connectGatt(BluetoothDevice remoteDevice, boolean autoConnect, BluetoothGattCallback bluetoothGattCallback) {
        ...
        try {
            BleLog.d("Trying to connectGatt using reflection.");
            Object iBluetoothGatt = getIBluetoothGatt(getIBluetoothManager());

            if (iBluetoothGatt == null) {
                BleLog.d("Couldn't get iBluetoothGatt object");
            ...
            if (bluetoothGatt == null) {
                BleLog.d("Couldn't create BluetoothGatt object");
                return connectGattCompat(bluetoothGattCallback, remoteDevice, true);
            }
            ...
            if (!connectedSuccessfully) {
                BleLog.d("Connection using reflection failed, closing gatt");
                bluetoothGatt.close();
            }
            ...
            BleLog.d(exception + "Error while trying to connect via reflection");
            return connectGattCompat(bluetoothGattCallback, remoteDevice, true);
        }
    }
    ...
    private BluetoothGatt connectGattCompat(BluetoothGattCallback bluetoothGattCallback, BluetoothDevice device, boolean autoConnect) {
        BleLog.d("Connecting without reflection");
    ...
    private static boolean connectUsingReflection(BluetoothGatt bluetoothGatt, BluetoothGattCallback bluetoothGattCallback,
        ...
        BleLog.d("Connecting using reflection");
    ...
    private BluetoothGatt createBluetoothGatt(Object iBluetoothGatt, BluetoothDevice remoteDevice)
        ...
        BleLog.d("Found constructor with args count = " + bluetoothGattConstructor.getParameterTypes().length);
