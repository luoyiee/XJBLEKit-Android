        ...
        startLeScan(new IBleScanCallback() {
            ...
            public void onLeDeviceScanned(final XJBleDevice XJBleDevice) {
                ...
                if (mac.equals(XJBleDevice.getMac())) {
                    stopScan();
                    BleConnect.getInstance().connect(XJBleManager.getInstance().getContext(), XJBleDevice, bleConnectCallback);
                }
            }
...
//        } else {
//            BleConnect bleConnect = XJBleManager.getInstance().getMultipleBluetoothController().buildConnectingBle();
